export const projects = [
  {
    ...
    stackLabel: "Architecture & workflows",
    stack: [
      "Multi-tenant CRM & field ops",
      "Dispatch & scheduling",
      "RLS-backed Postgres",
      "Stripe billing + portal",
      "Typed React + Vite",
      "Node/Express integrations",
      "Capacitor field app",
    ],
    theme: {
  ...
  },
  {
    ...
    stackLabel: "Product systems",
    stack: [
      "Realtime feeds & engagement",
  ...
  },
  {
    ...
    stackLabel: "SaaS delivery layer",
    stack: [
      "Plan-aware auth & access",
      "Stripe subscriptions + webhooks",
      "OpenAI via gated API",
      "Postgres-backed profiles",
      "Node/Express service boundary",
    ],
    theme: {
  ...
  },
  {
    ...
    stack: [
      ...
      "Local-first execution data",
      "Field pacing & visibility",
